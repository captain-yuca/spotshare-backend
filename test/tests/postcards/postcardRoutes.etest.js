...
describe('create postcard', () => {
  test('return 200 with created postcard')
  test('return 400 when nonexistant spot id')
  test('return 400 when nonexistant layout')
  test('using default template when spot does not have assigned template')
  test('using assigned template when spot has assigned template')
})
